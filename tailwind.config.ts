  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": { "0%,100%": { boxShadow: "0 0 20px hsl(217 91% 60% / 0.15)" }, "50%": { boxShadow: "0 0 40px hsl(217 91% 60% / 0.35)" } },
        "blueprint-draw": { from: { strokeDashoffset: "1200" }, to: { strokeDashoffset: "0" } },
      },
      animation: {
        ...
        "blueprint-draw": "blueprint-draw 4s ease-out forwards",
      },
    },
  },
