...
const PolitiqueConfidentialite = () => (
  <AppLayout>
    <div className="page-header">
      <h1 className="page-title flex items-center gap-2"><Shield className="h-6 w-6 text-accent" /> Politique de confidentialité</h1>
    </div>
    <Card className="max-w-3xl">
      <CardHeader><CardTitle className="text-lg font-sans">Politique de confidentialité — RGPD</CardTitle></CardHeader>
